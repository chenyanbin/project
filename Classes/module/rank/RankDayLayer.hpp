...
#ifndef RankDayLayer_hpp
#define RankDayLayer_hpp

#include "extensions/cocos-ext.h"
#include "../BaseLayer.h"
USING_NS_CC_EXT;
class RankDayLayer:public BaseLayer,TableViewDataSource,TableViewDelegate
{
public:
    RankDayLayer();
    ~ RankDayLayer();
    virtual bool init();
    static RankDayLayer* create();
private:
    void setPersonBg();
...
protected:
    ...
    void requestDayRankingMsg();
    void onDayRankingProcess(EventCustom* msg);
